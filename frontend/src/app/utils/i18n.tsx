...
const translations = {
  ...
  "method.about.p1": {
    en: "lønklar.dk is a free tool that helps people working in Denmark understand their salary, tax, and total compensation. We use the official 2026 rates from SKAT.",
    da: "lønklar.dk er et gratis værktøj, der hjælper folk, der arbejder i Danmark, med at forstå deres løn, skat og samlede kompensation. Vi bruger de officielle 2026-satser fra SKAT.",
    it: "lønklar.dk è uno strumento gratuito che aiuta chi lavora in Danimarca a comprendere stipendio, tasse e compenso totale. Utilizziamo le aliquote ufficiali del 2026 di SKAT.",
    de: "lønklar.dk ist ein kostenloses Tool, das Menschen in Dänemark hilft, ihr Gehalt, ihre Steuern und ihre Gesamtvergütung zu verstehen. Wir verwenden die offiziellen SKAT-Sätze 2026.",
    sv: "lønklar.dk är ett gratis verktyg som hjälper människor som arbetar i Danmark att förstå sin lön, skatt och totala ersättning. Vi använder de officiella SKAT 2026-satserna.",
    es: "lønklar.dk es una herramienta gratuita que ayuda a las personas que trabajan en Dinamarca a entender su salario, impuestos y compensación total. Usamos las tasas oficiales SKAT 2026.",
    nb: "lønklar.dk er et gratis verktøy som hjelper folk som jobber i Danmark med å forstå lønn, skatt og total kompensasjon. Vi bruker de offisielle SKAT 2026-satsene.",
  },
  "method.about.p2": {
